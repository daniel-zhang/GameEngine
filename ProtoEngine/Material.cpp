...
void DefaultMaterial::setDefault()
{
    ...
    mpObjMaterial->pData->Ambient = XMFLOAT4(0.8f, 0.8f, 0.8f, 1.0f);
    mpObjMaterial->pData->Diffuse  = XMFLOAT4(0.8f, 0.8f, 0.8f, 1.0f);
    mpObjMaterial->pData->Specular= XMFLOAT4(0.8f, 0.8f, 0.8f, 1.0f);
